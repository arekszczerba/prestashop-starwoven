# ./vendor/bin/behat -c tests/Integration/Behaviour/behat.yml -s discount --tags discount-condition-minimal-quantity
@restore-all-tables-before-feature
@discount-condition-minimal-quantity
Feature: Full UX discount test
  ...
  Scenario: Create a complete discount with free shipping using new CQRS
    ...
    When I create a "free_shipping" discount "free_shipping_discount_with_minimal_quantity" with following properties:
      | name[en-US] | Four products equal free shipping   |
      | name[fr-FR] | Quatre produit donne envoie gratuit |
      | active      | true                                |
      | valid_from  | 2025-01-01 11:05:00                 |
      | valid_to    | 2025-12-01 00:00:00                 |
      | code        | FREE_SHIPPING_4                     |
    And I update discount "free_shipping_discount_with_minimal_quantity" with following conditions:
      | minimum_product_quantity | 4 |
    And discount "free_shipping_discount_with_minimal_quantity" should have the following properties:
      | name[en-US]              | Four products equal free shipping   |
      | name[fr-FR]              | Quatre produit donne envoie gratuit |
      | active                   | true                                |
      | valid_from               | 2025-01-01 11:05:00                 |
    ...
    And my cart "dummy_cart" should have the following details:
      ...
      | total_discount | $0.00  |
      | total          | $37.00 |
    When I use a voucher "free_shipping_discount_with_minimal_quantity" on the cart "dummy_cart"
