...
import initGroupedItemSelector from '@PSVue/components/grouped-items-selector';
...
$(() => {
  ...
  initGroupedItemSelector('#discount_conditions_cart_conditions_product_segment_attributes', getAllAttributeGroups);
});
